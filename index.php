...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="index.html">TrustMedika</a></h1>
                        ...
                        <div class="row">
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>FLEXIBLE</h4>
                                    <p>Layanan dirumah atau langsung datang ke Klinik ? Tidak menjadi masalah.
                                        Flexibilitas layanan Trustmedika membantu Anda tetap aktif dimanapun
                                        kapanpun</p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <h4>AKURAT</h4>
                                    <p>Akurasi Bersama para tim professional dilakukan di seluruh laboratorium dan
                                        klinik mitra kami. Pengawasan kualitas tertinggi dikedepankan oleh Tim
                                        Trustmedika QA24.</p>
                                </div>
                            </div>
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box mt-4 mt-xl-0">
                                    ...
                                    <p>Tanpa antri lama dan hasil yang cepat dengan harga terjangkau adalah prioritas
                                        layanan Kami</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                    <h3>TrustMedika</h3>
                    <p>
                        Trustmedika adalah integrator Klinik, Konsultan kesehatan, dan Laboratorium terpecaya di
                        Indonesia yang mengedepankan hasil observasi laboratorium dan pengobatan.

                        Trustmedika hadir untuk membantu masyarakat mendapatkan klinik terpercaya dengan lebih mudah
                        dengan standarisasi yang telah Trustmedika tetapkan.

                        Saatnya world class health clinic dapat diakses dengan mudah oleh Anda dan keluarga. Hubungi
                        Medical Assistant Anda hari ini untuk mendapatkan layanan konsultasi Cuma-Cuma.</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="icon-box">
                        ...
                        <p>Mendeteksi virus covid-19 dengan Test Rapid Antibodi, Swab Antigen, dan Swab PCR.
                            ...
                            Untuk mendapatkan layanan ini, Anda dapat langsung menghubungi Kami langsung untuk respon
                            yang lebih cepat atau klik Daftar sekarang dan Medical Assistant Kami akan menghubungi anda
                            dalam 3x60 Menit</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="icon-box">
                        ...
                        <p>Vaksinasi untuk membantu membentuk imunitas tubuh karyawan dan keluarga karyawan. Layanan ini
                            mengedepankan flexibilitas bagi perusahaan yang mengedepankan kesejahteraan dan Kesehatan
                            keluarga karyawan, namun tetap mengedepankan efisiensi dan efektifitas program
                            Kesehatan.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <p>Cek immunologi hepatitis A, B, C, HIV, cek darah lengkap, cek urin lengkap, hingga paket
                            medical check up langsung dari rumah.</p>
                    </div>
                </div>
    ...
    <section id="gallery" class="gallery">
        ...
        <div class="container-fluid">
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-1.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-2.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-3.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-4.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-5.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-6.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-7.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-8.jpg" class="galery-lightbox">
                            <img src="assets/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
